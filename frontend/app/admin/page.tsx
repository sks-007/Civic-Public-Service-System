    ...
    <div className="flex min-h-screen flex-col">
      ...
      <Dialog open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          {selectedComplaint && (
            <div className="space-y-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-xs text-muted-foreground">Complaint ID</Label>
              ...
              {selectedComplaint.image_url && (
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    {selectedComplaint.image_verified ? (
                ...
                <div className="grid gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setSelectedComplaint({ ...selectedComplaint, status: value })}
                    >
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setSelectedComplaint({ ...selectedComplaint, priority: value })}
                    >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setSelectedComplaint({ ...selectedComplaint, officer: e.target.value })}
                  ...
                  {/* Progress */}
                  <div>
                    <Label htmlFor="progress">Progress ({selectedComplaint.progress}%)</Label>
                    <Input
                      id="progress"
                      type="number"
                      min="0"
                      ...
                      onChange={(e) => setSelectedComplaint({ ...selectedComplaint, progress: parseInt(e.target.value) || 0 })}
                    />
                    <Progress value={selectedComplaint.progress} className="mt-2" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsDetailsOpen(false)} disabled={isUpdating}>
              Cancel
            </Button>
