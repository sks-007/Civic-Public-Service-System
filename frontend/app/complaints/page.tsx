...
const allComplaints: Complaint[] = [
  {
    ...
    description: "The streetlight at 142 MG Road has been non-functional for over a week, creating a dark zone that poses safety risks for pedestrians and drivers at night.",
    location: "142 MG Road, Ward 3",
  ...
  },
  {
    ...
    description: "Large dumpster near Kendriya Vidyalaya has been overflowing for 3 days. Waste is spilling onto the sidewalk and causing a foul odor affecting students and nearby residents.",
  ...
  {
    id: "CMP-2026-0849",
    title: "Dangerous pothole on NH 48",
    description: "A large and deep pothole has formed on NH 48 near the intersection with Main Road. Multiple vehicles have been damaged and it is a serious hazard especially at night.",
    location: "NH 48, Ward 4",
  ...
  },
  {
    ...
    description: "Raw sewage is overflowing from a manhole on FC Road, flooding the road and nearby residential yards. The smell is unbearable and this is a health hazard.",
    location: "89 FC Road, Ward 2",
  ...
  {
    id: "CMP-2026-0851",
    title: "Broken playground equipment at Cubbon Park",
    description: "The main swing set and slide at Cubbon Park have broken chains and sharp exposed metal edges. Several children have gotten minor injuries. Needs immediate repair.",
    location: "Cubbon Park, Ward 5",
  ...
  },
  {
    ...
    description: "Multiple streetlights on Residency Road between #200-300 are out, creating a large dark zone. Residents feel unsafe walking at night and there have been reports of suspicious activity.",
    location: "250 Residency Road, Ward 3",
    department: "Street Lighting",
    departmentIcon: Lightbulb,
    date: "2026-02-28",
    status: "submitted",
  ...
  },
  {
    ...
    description: "Construction debris and household waste are being illegally dumped near the river bank on River Bank Road. This is causing water contamination and environmental damage.",
    location: "River Bank Road, Ward 2",
    department: "Waste Management",
    departmentIcon: Trash2,
    date: "2026-02-26",
    status: "assigned",
  ...
  },
  {
    ...
    description: "The bus shelter at the corner of Market Street and Station Road was hit by a vehicle. The glass panels are shattered and the bench is broken, leaving commuters exposed to weather.",
    location: "Market Street & Station Road, Ward 1",
    department: "Transportation",
    departmentIcon: Bus,
    date: "2026-02-26",
    status: "in-progress",
  ...
  {
    id: "CMP-2026-0855",
    title: "Burst water main on Indiranagar",
    description: "A water main has burst on Indiranagar causing flooding on the street and water pressure drops for nearby homes. The road has become impassable for vehicles.",
    location: "Indiranagar, Ward 4",
    department: "Water & Sewage",
    departmentIcon: Droplets,
    date: "2026-02-27",
    status: "in-progress",
  ...
  },
  {
    ...
    description: "The walking pathway in Lalbagh Gardens is completely blocked by overgrown bushes and fallen branches. Joggers and walkers have to detour through the main road.",
    location: "Lalbagh Gardens, Ward 5",
    department: "Parks & Recreation",
    departmentIcon: Trees,
    date: "2026-02-25",
    status: "submitted",
