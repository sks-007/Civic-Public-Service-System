                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            <SelectItem value="mayor">Municipal Commissioner's Office</SelectItem>
            ...
            <div className="flex flex-col gap-4 lg:col-span-2">
              <Card className="border-border">
                <CardContent className="flex flex-col gap-5 pt-6">
                  ...
                  {[
                    { icon: Phone, label: "Emergency Line", value: "+91-112" },
                    { icon: Phone, label: "General Helpline", value: "+91-80-2266-1000" },
                    { icon: Mail, label: "Email", value: "support@cpss.gov.in" },
                    { icon: MapPin, label: "Municipal Office", value: "Municipal Corporation Building, Dr. B.R. Ambedkar Veedhi" },
                    { icon: Clock, label: "Office Hours", value: "Mon-Sat: 9:30 AM - 5:30 PM" },
                  ].map((item) => (
              ...
              <Card className="border-border bg-gradient-to-br from-primary/5 to-accent/[0.02]">
                <CardContent className="pt-6">
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      { name: "Meera Nair", role: "Director of Public Works" },
                      { name: "Rajesh Kumar", role: "Transportation Commissioner" },
                      { name: "Dr. Priya Patel", role: "Water Authority Chief" },
                      { name: "Vikram Iyer", role: "Parks & Recreation Director" },
                    ].map((person) => (
